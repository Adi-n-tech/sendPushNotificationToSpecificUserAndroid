...
public class FcmNotificationsSender {
    ...
    private final String mFcmServerKey = "AAAAsMqEaFM:APA91bEaZ2nkhRk6VB1XXQEwr0AIzNWA4bvNiqujkSVcssTlTpfWhi2VCBHgaxCXgDEEqspLpKTthHCY78oRWEJWcYCllSkPJlV7gS_p_gBng7gkS-BBFfKslGX4skrjAQCehwkjg9WE";
    ...
    public void SendNotifications() {
        ...
        try {
            ...
            notiObject.put("icon", R.drawable.notify_icon); // enter icon that exists in drawable only
            ...
            JsonObjectRequest request = new JsonObjectRequest(Request.Method.POST, mPostUrl, mainObj, new Response.Listener<JSONObject>() {
                ...
                public Map<String, String> getHeaders() throws AuthFailureError {
                    ...
                    header.put("authorization", "key=" + mFcmServerKey);
                    return header;
